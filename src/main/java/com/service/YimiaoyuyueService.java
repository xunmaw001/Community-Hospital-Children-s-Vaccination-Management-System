...
public interface YimiaoyuyueService extends IService<YimiaoyuyueEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<YimiaoyuyueEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<YimiaoyuyueEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<YimiaoyuyueEntity> wrapper);
}
